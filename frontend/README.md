...
Add `volto-collective-referencecontent` to your `package.json`.

```json
"dependencies": {
    "volto-collective-referencecontent": "*"
}
```

Add `volto-collective-referencecontent` to your `volto.config.js`.
...
```javascript
const theme = 'volto-collective-referencecontent';
```
...
yo @plone/volto my-volto-project --addon volto-collective-referencecontent
cd my-volto-project
```
...
1.  Clone this repository, then change your working directory.
    ...
    cd collective-referencecontent/frontend
    ```
