...
myst:
  html_meta:
    ...
    "property=og:title": "Plone Add-On for alias contents"
    "keywords": "Plone Add-On for alias contents, documentation, A new project using Plone 6."
---

# Plone Add-On for alias contents

Welcome to the documentation for Plone Add-On for alias contents!
